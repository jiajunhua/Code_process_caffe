...
dir_list = os.listdir("C:\\Users\\way\\Desktop\\DataAug\\Cell\\111")
IMAGE_SIZE = 256

for dir in dir_list:
    image_files = glob.glob("C:\\Users\\way\\Desktop\\DataAug\\Cell\\111\\*.BMP")
    ...
    for i, image in enumerate(image_list):
        misc.imsave(os.path.join("C:\\Users\\way\\Desktop\\DataAug\\Cell\\111_bright", str(i) + '.jpg'), image)
